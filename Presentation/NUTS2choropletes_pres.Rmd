...
EU 2013 Unemployment rates by NUTS2 regions, percentage of total population. Source: [Eurostat (tgs00010)](https://raw.githubusercontent.com/Tungurahua/R_examples/master/Example01/NUTS2choropletes_script.R)
...
EU 2010-13 Unemployment rates by NUTS2 regions, percentage of total population Source: [Eurostat (tgs00010)](https://raw.githubusercontent.com/Tungurahua/R_examples/master/Example01/NUTS2choropletes_script.R)
...
```{r windowdressing2, message=FALSE,warning=FALSE,tidy=FALSE,echo=FALSE}
<<windowdressingx>>
```
...
## Apply facets to improve readability
```{r betterplot,fig.width=6,fig.height=6,warning=FALSE,message=FALSE,echo=FALSE}
<<betterplot>>
```
