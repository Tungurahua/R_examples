...
\begin{itemize}
  ...
  \item \texttt{OBS} is the actual numeric observaion value.
...
download.file(paste0("http://ec.europa.eu/eurostat/cache/",
              ...
              destfile = "shp/NUTS_2010_60M_SH.zip")

# Unzip the data in a temporary location
unzip("shp/NUTS_2010_60M_SH.zip",
      exdir="shp/NUTS_2010_60M_SH")
...
eurMap <- readOGR(paste0("shp/NUTS_2010_60M_SH/NUTS_2010_60M_SH/",
...
#download.file("http://thematicmapping.org/downloads/TM_WORLD_BORDERS-0.3.zip", destfile = "shp/TM_WORLD_BORDERS-0.3.zip")
#unzip("shp/TM_WORLD_BORDERS-0.3.zip", exdir="shp/TM_WORLD_BORDERS-0.3")

TM_WORLD_BORDERS3 <- readOGR("shp/TM_WORLD_BORDERS-0.3/",
